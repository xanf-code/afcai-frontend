    ...
    <div>
      ...
      <div className="max-w-2xl md:mx-auto md:mt-6 m-5">
        ...
        <div className="space-y-4 font-IBMSans font-normal tracking-wide text-justify pt-4 text-gray-800">
          ...
          <p>
            Our view is to help each club right from inception to reaching their
            long term goals in the football circuit. We aim to groom and help
            each club develop in terms of running operations to managing
            finances and also give a hand in managing and solving club and
            academy related issues. We invite all clubs and academics to be a
            part of this body and help develop India into a footballing nation.
          </p>
          <p>
            We are an organisation purely focused on the welfare and progress of
            Football clubs & Academies all over the country. Our aim is to
            enhance the existence of Football Clubs & academies in India, in
            terms of Knowledge and Resources. We want to promote Club Culture
            and have its widespread impact in every corner of the nation.
          </p>
          <p>
            Our vision and mission is to help football clubs & academies to
            operate and become sustainable with a view to make football
            available to all, irrespective of their age, gender, religion, caste
            and all criteria possible.
          </p>
          <p>
            AFCAI has been formed to help bridge the gap between the thousands
            of clubs in India and the All India Football Federation (AIFF). We
            ...
            raise India as a Footballing Nation.
          </p>
        </div>
        <p className="mt-10 text-xs font-normal font-IBMSans text-gray-600">
          Last Updated <span className="text-gray-800">14/09/22</span>
        </p>
      </div>
    </div>
  );
