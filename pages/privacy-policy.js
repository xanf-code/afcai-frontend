...
function Privacy() {
  return (
    <div>
      <Head>
        <title>AFCAI - Privacy Policy</title>
        <meta
          name="description"
      ...
      <div className="font-IBMSans max-w-3xl md:mx-auto md:mt-6 m-5 text-justify">
        <div>
        ...
        <h1>
          Privacy Policy for Association Of Football Clubs &amp; Academies In
          India
        </h1>

        <p>
          At AFCAI, accessible from https://afcai.in/, one of our main
          priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by AFCAI and how we use it.
        </p>
        ...
        <p>
          ...
          shared and/or collect in AFCAI. This policy is not applicable to any
        ...
        <p>
          AFCAI follows a standard procedure of using log files. These files log
        ...
        <p>
          ...
          advertising partners of AFCAI.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on AFCAI, which are sent directly
        ...
        <p>
          Note that AFCAI has no access to or control over these cookies that
        ...
        <p>
          AFCAI's Privacy Policy does not apply to other advertisers or
        ...
        <p>
          AFCAI does not knowingly collect any Personal Identifiable Information
